              ...
              <div class="items__controls">
                <div class="flex" v-if="user">
                  ...
                  <div class="flex items-center mr-4">
                    <img class="w-8 h-8 rounded-full mr-2" src="https://lh3.googleusercontent.com/ogw/ADGmqu9c092rxbVDNs46Z96V6rfvVyagI4iBgxtoR0LRmoU=s32-c-mo" alt="Avatar of Javier Diaz">
                    <div class="text-sm">
